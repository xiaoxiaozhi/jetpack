...
class ViewModelFragment : Fragment() {
    //    val viewModel: ScopeViewModel by viewModels(
//        ownerProducer = { requireParentFragment() }
//    )

//    val viewModel: ScopeViewModel by activityViewModels()

//    val sc: ScopeViewModel by navGraphViewModels(R.id.nav_graph)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: String, param2: String) = ViewModelFragment().apply {

...
data class MediaStoreFile(
    ...
    companion object {
        val DiffCallback = object : DiffUtil.ItemCallback<MediaStoreFile>() {
            override fun areItemsTheSame(oldItem: MediaStoreFile, newItem: MediaStoreFile) =
                oldItem.id == newItem.id

            override fun areContentsTheSame(oldItem: MediaStoreFile, newItem: MediaStoreFile) =
                oldItem == newItem
        }
    }
}